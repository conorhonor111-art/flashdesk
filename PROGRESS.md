...
### v0.4.0-35 — 2026-09-22 — Build verification release

No source changes. Build confirmed clean (0 errors, 0 warnings) against `e11149a`.
...
**Released as `v0.4.0-35`** — built from `e11149a`, GitHub (`FlashDesk.exe` +
